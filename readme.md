...
✨ Главные фишки
   ...
   nano-banana-pro — Генерация в два этапа с улучшением (Redo with Pro). Максимальное качество, работает только с подпиской.

   nano-banana-2 — Базовая генерация (1 этап). Быстрее, доступно и без подписки.
